...
//            String username = client.getHandshakeData().getSingleUrlParam("room");
            ...
            socketService.saveInfoMessage(client, String.format(SocketConstants.WELCOME_MESSAGE, username), room);
    ...
    private DisconnectListener onDisconnected() {
        return client -> {
            ...
            String room = params.get("room").stream().collect(Collectors.joining());
            String username = params.get("username").stream().collect(Collectors.joining());
            socketService.saveInfoMessage(client, String.format(SocketConstants.DISCONNECT_MESSAGE, username), room);
