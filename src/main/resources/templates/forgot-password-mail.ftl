                                    ...
                                    <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                        ...
                                        <tr>
                                            ...
                                            <td class="tw-card-header"
                                                ...
                                                align="center"><span
                                                        style="font-weight: 600;">Email Link forgot token</span></td>
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Thank you for joining <strong>TopicTalks Application</strong>, an efficient and smart solution to manage your conversation!</span><br/><br/><span
                                                            style="font-weight: 400;">To complete the forgot password process, please confirm to reset your account's password with the link below:</span>
                                                                ...
                                                                <tr>
                                                                    <td class="button__td "
                                                                        ...
                                                                        <![endif]--> <!-- [if !mso]><!--> <a
                                                                                ...
                                                                                href="${userForgotPasswordLink}"
                                                                                target="_blank"
                                                                                rel="noopener">Link Reset</a> <!--![endif]--></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
